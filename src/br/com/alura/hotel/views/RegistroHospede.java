...
import br.com.alura.hotel.utils.LerDeArquivo;
...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede() {
		...
		txtNreserva.setText(
				!Objects.requireNonNull(LerDeArquivo.leituraDeArquivo()).toString().equals("") ? LerDeArquivo.leituraDeArquivo().toString() : "NaN"
		);
		...
		btnsalvar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				hospedeController.salvar(
						txtNome.getText(),
						txtSobrenome.getText(),
						new java.sql.Date(txtDataN.getDate().getTime()),
