...
import br.com.alura.hotel.controller.AdministradorController;
...
public class Login extends JFrame {
	...
	private void Login() {
		...
		String senha = new String(
				!administradorController.buscar(usuario).isEmpty() ?
						administradorController.buscar(usuario).get(0).getSenha()
						:
						"");
